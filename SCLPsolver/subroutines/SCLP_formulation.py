...
class SCLP_formulation():
    ...
    def formulate_ratesLP(self, x_0, q_N):
        ...
        pn = np.hstack((np.arange(1, self.K + 1, dtype =  np.dtype(int)), -np.arange(self.J + 1, self.J + self.I + 1, dtype =  np.dtype(int)))).astype(int)
        ...
        dn = np.hstack((-np.arange(1, self.J + 1, dtype =  np.dtype(int)), np.arange(self.K + 1, self.K + self.L + 1, dtype =  np.dtype(int)))).astype(int)
