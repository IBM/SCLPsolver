...
#'#@profile
def LP_formulate(AA, prim_name, dual_name,  Kset, nJset, tmp_matrix, tolerance = 0):
    ...
    A, pn, dn, ps, ds, err = simplex_procedures(AA.copy(), prim_name.copy(), dual_name.copy(), prim_sign, dual_sign, tmp_matrix, tolerance)
    return pn, dn, A