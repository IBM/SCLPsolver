...
c = matrix(1,2)
print("\noriginal matrix size ",c.get_matrix().shape)
c.enlarge()
print("new matrix size ",c.get_matrix().shape, "actual matrix size ", c._matrix.shape)
c.enlarge()
print("new matrix size ",c.get_matrix().shape, "actual matrix size ", c._matrix.shape)
c.enlarge()
print("new matrix size ",c.get_matrix().shape, "actual matrix size ", c._matrix.shape)
...
c.enlarge()
print("new matrix size ",c.get_matrix().shape, "actual matrix size ", c._matrix.shape)
c.set_matrix(np.zeros((6, 6)))
print("new matrix size ",c.get_matrix().shape, "actual matrix size ", c._matrix.shape)
c.enlarge()
print("new matrix size ",c.get_matrix().shape, "actual matrix size ", c._matrix.shape)
c.set_matrix(np.zeros((60, 60)))
print("new matrix size ",c.get_matrix().shape, "actual matrix size ", c._matrix.shape)