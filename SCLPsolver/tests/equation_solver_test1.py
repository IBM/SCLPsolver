...
for i in range(times_to_run):
    ...
    if i == 0:
        ...
        # step 9
        equation_solver_9 = generic_equation_solver(matrix_size)
    ...
    p = random_column_vector_5_2[index_to_replace]
    # step 6
    ...
    print("Index:", index_to_replace)
    print("Pivot element:", p)
    print("Are Numpy and new Algorithm results the same? :", np.allclose(matrix_2, result_11))
    print("Abs error:", max(abs(matrix_2 - result_11)))
    print("Rel error:", max(abs(matrix_2 - result_11)/abs(matrix_2)))
...
# step 9
equation_solver_9 = generic_equation_solver(matrix_size * 2)
equation_solver_9.set_inverse_matrix(matrix_3)
...
equation_solver_test = generic_equation_solver(matrix_size)
