...
from subroutines.SCLP_solution5 import SCLP_solution
...
from subroutines.SCLP_solver5 import SCLP_solver
...
#
    ...
    solution = SCLP_solution(np.vstack(pn.copy()), np.vstack(dn.copy()), [], new_bs, dx, dq)
