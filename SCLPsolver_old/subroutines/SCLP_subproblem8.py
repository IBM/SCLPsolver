import numpy as np
from .SCLP_solution8 import SCLP_solution
from .parametric_line8 import parametric_line
from .prepare_subproblem_data8 import prepare_subproblem_basis
...
def SCLP_subproblem(pbaseDD,dbaseDD,DD, v1,v2,Kset_0, Jset_N,
    ...
    from .SCLP_solver8 import SCLP_solver
