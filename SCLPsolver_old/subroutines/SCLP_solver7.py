...
from .classification7 import classification
    ...
    while col_info.case != 'complete' and col_info.case != 'solved__':
        ...
        if rewind_required:
            if DEPTH == 0:
                ...
                resolved = False
                while lastCollision is not None and not resolved:
        ...
        if col_info.case == 'Case i__':
            ...
            solution, STEPCOUNT, ITERATION, pivot_problem = SCLP_pivot(param_line.Kset_0, param_line.Jset_N, solution,
                                                                       col_info, KK, JJ, NN, totalK, totalJ, DEPTH,
        ...
        if not rewind_required:
            ...
            lastCollision  = col_info
            lastCollision.theta = theta
            lastCollision.lastN1 = lastN1
            lastCollision.lastN2 = lastN2
